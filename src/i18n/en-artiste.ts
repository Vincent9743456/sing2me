...
export const EN_ARTISTE: Record<string, string> = {
  ...
  '✓ Invitation envoyée à {name} — elle l’attend dans son onglet Groupes, et un e-mail la prévient. Si elle ne reçoit rien d’ici quelques minutes, envoie-lui plutôt un lien d’invitation (bouton ci-dessous) : lui fonctionne avec le compte qu’elle utilise vraiment.':
    '✓ Invitation sent to {name} — it’s waiting in their Bands tab, and an email lets them know. If nothing arrives within a few minutes, send them an invitation link instead (button below): that one works with whichever account they actually use.',
