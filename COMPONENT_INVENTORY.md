...
| PublicPagePeek | PublicPagePeek.tsx | ✅ | L'aperçu depuis l'app (b242) : adresse + « Copier », QR en grand (enregistrable, partageable), puis la page RELUE depuis le serveur après republication. Utilisé pour l'artiste (onglet Artiste) et pour un groupe (`BandPublicPeek`). Ne jamais y remettre de raccourcis e-mail/WhatsApp : « n'ont pas d'utilité » |
